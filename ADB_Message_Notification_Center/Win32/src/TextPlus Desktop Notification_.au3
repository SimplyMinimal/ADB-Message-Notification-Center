...
#AutoIt3Wrapper_Outfile=TextPlus Desktop Notification.exe
...
Global $PROGRAM_NAME = "TextPlus New Message Notification System"
Opt("TrayMenuMode", 1)
...
While True
	...
	If StringInStr($data, "Displayed com.gogii.textplus") Then;Match Found
		$New_Message_Count += 1
